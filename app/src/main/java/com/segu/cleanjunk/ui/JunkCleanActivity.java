...
import com.segu.cleanjunk.callback.IScanCallback;
import com.segu.cleanjunk.model.JunkGroup;
import com.segu.cleanjunk.model.JunkInfo;
import com.segu.cleanjunk.task.OverallScanTask;
import com.segu.cleanjunk.task.ProcessScanTask;
import com.segu.cleanjunk.task.SysCacheScanTask;
import com.segu.cleanjunk.ui.view.ListHeaderView;
import com.segu.cleanjunk.util.CleanUtil;
import com.segu.cleanjunk.utils.LogUtils;
...
public class JunkCleanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(@NonNull Message msg) {
                JunkCleanActivity.this.handleMessage(msg);
                return false;
            }
        });
    ...
    private void handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case MSG_SYS_CACHE_POS:
                mHeaderView.mProgress.setText("Quét:" + ((JunkInfo) msg.obj).mPackageName);
            ...
            case MSG_SYS_CACHE_CLEAN_FINISH:
                ...
                if (bundle != null) {
                    ...
                    if (hanged) {
                        Toast.makeText(JunkCleanActivity.this, "Bất thường trong việc xóa bộ nhớ cache của hệ thống！", Toast.LENGTH_SHORT)
                                .show();
                    }
                }
                break;
            ...
            case MSG_OVERALL_POS:
                mHeaderView.mProgress.setText("Quét:" + ((JunkInfo) msg.obj).mPath);
                mHeaderView.mSize.setText(CleanUtil.formatShortFileSize(JunkCleanActivity.this, getTotalSize()));
                break;
    ...
    private void checkScanFinish() {
        ...
        if (mIsProcessScanFinish && mIsSysCacheScanFinish && mIsOverallScanFinish) {
            ...
            mHeaderView.mProgress.setText("Tìm:" + totalSize);
    ...
    private void checkCleanFinish() {
        if (mIsProcessCleanFinish && mIsSysCacheCleanFinish && mIsOverallCleanFinish) {
            mHeaderView.mProgress.setText("Dọn dẹp xong");
    ...
    private long getTotalSize() {
        ...
        for (JunkGroup group : mJunkGroups.values()) {
            size += group.mSize;
            if (group.mName.equals("Bộ nhớ cache rác")){
                LogUtils.logJson(mJunkGroups.values());
            }
        }
        return size;
    }
    ...
    public static class GroupViewHolder {
        ...
        TextView mPackageSizeTv;
    }

    public static class ChildViewHolder {
        TextView mJunkTypeTv;
